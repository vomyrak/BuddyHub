...
const method_html = "<div>Method: <br>" +
  "&#8195;Method Name: <input type=\"text\" minlength=\"2\" class=\"form-control\" name=\"method\" placeholder=\"Name of the method(e.g. turn on, etc.)\" required title=\"Minimum 2 character\"/>" +
...
const function_html = "<div>Function: <br>" +
  "&#8195;Function Name: <input type=\"text\" minlength=\"2\" class=\"form-control\" name=\"function\" placeholder=\"Name of the function in the library(e.g. turnOn, etc.)\" required title=\"Minimum 2 character\"/>" +
  "&#8195;Continuous? <input type=\"checkbox\" class=\"form-control\" name=\"continuous\" value=\"true\"><br>" +
