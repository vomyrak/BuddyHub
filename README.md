...
BuddyHub interacts with third-party devices via HTTP requests to the RESTful API endpoints of integrated devices which are supplied by developers through our developer portal.
